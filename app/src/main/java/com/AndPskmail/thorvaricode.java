 ...
 * @author rein
 */
public class thorvaricode {
    
static    final String thor_varicode[] = {
...
static final int thor_varidecode[] = {
...
public static  String thorvarienc(int c, int sec)
{
	if (sec == 0)
		return mfskVaricode.varienc(c);       // mfsk varicode
	else
		if (c >= ' ' && c <= 'z')
			return thor_varicode[c - ' '];
		
	return mfskVaricode.varienc(0);        // return code for NULL if not in tables
}

static int thorvaridec(int symbol)
{
	int i;
