...
// The same in a format more suitable for decoding.
	...
	"8",     "9",     ":",     ";", "<",     "=",     ">",     "?", // 56-63
	"@",     "A",     "B",     "C", "D",     "E",     "F",     "G", // 64-6
	"H",     "I",     "J",     "K", "L",     "M",     "N",     "O", // 72-77
	"P",     "Q",     "R",     "S", "T",     "U",     "V",     "W", // 80-85
	"X",     "Y",     "Z",     "[", "\\",    "]",     "^",     "_", // 88-93
	"`",     "a",     "b",     "c", "d",     "e",     "f",     "g", // 96-101
	"h",     "i",     "j",     "k", "l",     "m",     "n",     "o", // 104-109
	"p",     "q",     "r",     "s", "t",     "u",     "v",     "w", // 112-117
	"x",     "y",     "z",     "{", "|",     "}",     "~",     "<DEL>"    // 118-127
    };


    public static String getAscii(int c) {
        if(Math.abs(c) >= 128)
            return(new String(">127=" + c));
        return(ascii[c]);
    }

    public static String psk_varicode_encode(int c)
    {
